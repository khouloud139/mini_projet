 ...
 */
final class Version20230411132446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo ADD user_id INT NOT NULL, ADD type VARCHAR(255) NOT NULL, ADD description VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo DROP user_id, DROP type, DROP description');
    }
}
